...
#define FLAG_VAR(v) float* const _aux_ = &(v)
...
#define TEST_FLAG_SWEEP(g,f)     (((unsigned int) LOCAL(g, FLAGS)) & (f))
#define SET_FLAG_SWEEP(g,f)      {LOCAL(g, FLAGS) = ((unsigned int) LOCAL(g, FLAGS)) | (f);}
#define CLEAR_FLAG_SWEEP(g,f)      {LOCAL(g, FLAGS) = ((unsigned int) LOCAL(g, FLAGS)) & ~(f);}
#define CLEAR_ALL_FLAGS_SWEEP(g) {LOCAL(g, FLAGS) = ((unsigned int) 0);}
...
#define TEST_FLAG(g,x,y,z,f)     (((unsigned int) GRID_ENTRY(g, x, y, z, FLAGS)) & (f))
#define SET_FLAG(g,x,y,z,f)      {GRID_ENTRY(g, x, y, z, FLAGS) = ((unsigned int) GRID_ENTRY(g, x, y, z, FLAGS)) | (f);}
#define CLEAR_FLAG(g,x,y,z,f)    {GRID_ENTRY(g, x, y, z, FLAGS) = ((unsigned int) GRID_ENTRY(g, x, y, z, FLAGS)) & ~(f);}
#define CLEAR_ALL_FLAGS(g,x,y,z) {GRID_ENTRY(g, x, y, z, FLAGS) = ((unsigned int) 0);}
